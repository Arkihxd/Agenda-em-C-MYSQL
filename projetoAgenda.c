...
void main(void){
      ...
      mysql_init(&conexao);
      if ( mysql_real_connect(&conexao, "infoprojetos.com.br", "info16_mateus", "08021988", "info16_mateus", 3132, NULL, 0) ){
       	...
       	if(op == 1){
			...
			__fpurge(stdin);
			   ...
			   else if(opcao==2){ //Cadastro cidade
